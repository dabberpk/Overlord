...
def getDict():
    ...
    dbConfig["db_args"]="-cp /home/vagrant/YCSB-TS/ngdbc.jar -p db.driver=com.sap.db.jdbc.Driver -p db.url=jdbc:sap://%%IP%%:30013/?databaseName=SYSTEMDB -p db.user=SYSTEM -p db.passwd=123qweASD"
    ...
    dbConfig["prerun"]= ["cd ~"]
    dbConfig["postrun"]= []
    dbConfig["prerun_master"]= [ "%%SSH%%sudo -u hxeadm /usr/sap/HXE/HDB00/HDB start","%%SSH%%sudo -u hxeadm /usr/sap/HXE/HDB00/exe/hdbsql -i 00 -n localhost:30013 -u SYSTEM -p 123qweASD -I /home/vagrant/files/create_table.mysql" ] 
